...
Under the "function" folder of this repository, we can find the msgbox.cpp file, but this is called as a library, we can view "example.cpp", which provides a simple example, and this function is also very simple to use.  
